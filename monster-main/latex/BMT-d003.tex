...
\begin{document}
\maketitle
\par{Given two \ForesterRef{BMT-d002}{structures} in a \ForesterRef{BMT-d001}{language} \(\mathcal {L}\) \(\mathcal {A}\) and \(\mathcal {B}\), a \emph{homomorphism} \(\varphi :  \mathcal {A}  \rightarrow   \mathcal {B}\)
