...
\author{Adam Melrod \and Connor Lockhart \and Morgan Bryant\thanks{With contributions from connorlockhart.}}
...
Quantifier Elimination is a broader technique in Model Theory where for a structure in a given language, an arbitrary formula can be written as a boolean combination of perhaps simpler formulas
